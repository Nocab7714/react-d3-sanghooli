                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body mt-5 mb-5 text-center">
                            {deleteMode === 'single' ? (
                                <>
                                    確定要刪除這筆編號：<span className="fw-bold text-secondary">{tempOrder?.id}</span> 訂單嗎？
                                </>
                            ) : (
                                <>
                                    確定要刪除
                                    <span className="fw-bold text-secondary p-1 fs-5">所有訂單</span>嗎？
                                    <p className='p-1 mt-1'>此操作就像變了新的女友回不來喔（ 無法復原 ）!!</p>
                                </>
                            )}
                        </div>
                        <div className="modal-footer">
                            ...
                            <button
                                onClick={deleteMode === 'single' ? handleDeleteOrderItem : handleDeleteOrdersList}
                                type="button"
