          ...
          {cart?.carts?.length > 0 ? (
            <>
              ...
              <div className="pb-19">
                <form
                  onSubmit={onSubmit}
                  className="h6 border-bottom border-neutral40 border-lg-0 pb-6"
                >
                  <div className="row">
                    <div className="col-lg-8">
                      <legend className="bg-primary py-5 px-8 mb-0 fw-semibold fw-md-bold rounded-top-4">
                        購買收件資訊
                      </legend>
                    ...
                    <div className="col-lg-4">
                      <div className="mt-6 mt-lg-0 mt-xl-0 bg-white">
                        <h4 className="bg-primary py-5 px-8 mb-0 fw-semibold fw-md-bold rounded-top-4">
                          您的訂單明細
                        </h4>
                        <div className="p-8 border border-primary rounded-bottom-4">
                          ...
                          {cart?.carts?.map((cartItem) => (
                            ...
                            >
                              ...
                              <div className="flex-fill">
                                ...
                                <p className="fs-7">
                                  NT$ {cartItem.product.price * cartItem.qty}
                                </p>
                          ...
                          <div className="border-top border-bottom py-5">
                            ...
                            <div className="d-flex justify-content-between align-items-center fs-7 mb-5 mb-md-6">
                              <p>總金額</p>
                              <p className="fw-bold">
                                NT$ <span>{cart?.total.toLocaleString()}</span>
                              </p>
                            </div>
                            <div className="d-flex justify-content-between align-items-center fs-7 mb-5 mb-md-6">
                              <p>運費</p>
                          ...
                          <div className="d-flex justify-content-between align-items-center my-4">
                            ...
                            <p className="text-primary-dark fs-4 fw-bold">
                              NT$
                              <span className="ms-1">
                                {Math.floor(cart?.final_total).toLocaleString()}
                              </span>
                            </p>
                          </div>
                        </div>
                  ...
                  <div className="row">
                    <div className="col-lg-8">
                      ...
                      <div className="d-flex flex-wrap flex-xl-nowrap gap-5">
                        <Link
                          to="/cart"
                          className="btn btn-lg btn-outline-primary w-100 w-xl-50"
                        >
                          回到購物車
                        </Link>
                        <button
                          type="submit"
                          className="btn btn-lg btn-primary w-100 w-xl-50 "
                        >
                          提交訂單，前往付款
                        </button>
                      </div>
