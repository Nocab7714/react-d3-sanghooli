      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-8 ps-5 mb-19 mt-4">
            {/* <!-- 資訊說明區塊（右側） --> */}
            <div className="policy-section" ref={shippingRef}>
              <h4>配送方式</h4>
              <p className="fs-6 text-neutral60 mb-6 mt-6">
                我們提供靈活的配送選項，確保禮物準時送達：
              </p>
              <ol className="ordered-list fs-6">
                <li className="mb-2 text-neutral60">
                  <strong className="text-black">標準配送：</strong>
                  訂單確認後 3-5 個工作日內送達，適合計劃送禮的場合。
                </li>
                <li className="mb-2 text-neutral60">
                  <strong className="text-black">快速配送：</strong>
                  當天出貨，最快 24 小時內送達（僅限部分地區）。
                </li>
                <li className="mb-2 text-neutral60">
                  <strong className="text-black">指定日期配送：</strong>
                  選擇您希望的日期，精準將禮物送到收禮人手中。
                </li>
                <li className="mb-2 text-neutral60">
                  <strong className="text-black">國際配送：</strong>
                  支持部分國家和地區，讓禮物跨越距離傳遞心意。
                </li>
                <li className="text-neutral60">
                  所有商品都將採用安全包裝，確保完整無損地送到您手中。
                </li>
              </ol>
            </div>

            <div ref={returnPolicyRef} className="policy-section">
              <h4 className="mt-19">退換貨規則</h4>
              <p className="fs-6 text-neutral60 mb-6 mt-6">
                我們致力於提供滿意的購物體驗，若需退換貨請參考以下規則：
              </p>
              <ol className="ordered-list fs-6">
                <li className="mb-2 text-neutral60">
                  <strong className="text-black">退換貨期限：</strong>
                  收到商品後 7 天內可申請退換貨（以簽收日為準）。
                </li>
                <li className="mb-2 text-neutral60">
                  <strong className="text-black">申請條件：</strong>
                  商品需保持全新狀態，包含完整包裝、吊牌及附贈品。
                </li>
                <li className="mb-2 text-neutral60">
                ...
                <li className="mb-2 text-neutral60">
                  ...
                  <ul>
                    <li className="mt-2 mb-2">
                      個人化商品（如客製卡片）不接受退換，除非產品有明顯瑕疵。
                    </li>
                    <li>因個人使用不當導致的損壞恕不受理。</li>
                  </ul>
                </li>
                <li className="text-neutral60">
                  如需協助，歡迎隨時聯繫我們的客服團隊，我們將竭誠為您服務！
                </li>
              </ol>
            </div>
          </div>
