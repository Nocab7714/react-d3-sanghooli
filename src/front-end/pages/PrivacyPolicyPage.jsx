...
const PrivacyPolicyPage = () => {
  ...
  const servicePolicyRef = useRef(null);
            ...
            <ol className="ordered-list fs-6">
              <li className="mb-2 text-neutral60">
                ...
                <p className="mt-2 mb-2">
                  在您使用本網站時，我們可能會蒐集以下資訊：
                </p>
                <ul>
                  <li className="mt-2 mb-2">
                    <strong className="text-black">基本資訊：</strong>
                    如姓名、聯絡方式、配送地址等，僅用於處理訂單及配送商品。
                  </li>
                  <li className="mt-2 mb-2">
                    <strong className="text-black">付款資訊：</strong>
                    如信用卡號碼或支付帳戶資訊，我們不會儲存此類資料，交易由第三方支付平台安全處理。
                  </li>
                  <li>
                    <strong className="text-black">網站互動數據：</strong>
                    如瀏覽紀錄、點擊行為等，僅用於優化用戶體驗。
                  </li>
                </ul>
              </li>
              ...
              <li className="mb-2 mt-6 text-neutral60">
                ...
                <p className="mt-2 mb-2">
                  我們絕不會向第三方出售您的個人資料。僅在以下情況下分享您的資訊：
                </p>
                <ul>
                  <li className="mt-2 mb-2">
                    為完成配送或付款需求與合作夥伴（如物流公司或支付平台）共享必要資訊。
                  </li>
              ...
              <li className="mb-2 mt-6 text-neutral60">
                ...
                <p className="mt-2 mb-2">
                  我們採用業界領先的加密技術及安全措施，確保您的個人資料不被未授權存取或洩露。
                </p>
              </li>
              ...
              <li className="mb-2 mt-6 text-neutral60">
                ...
                <p className="mt-2 mb-2">
                  您可隨時要求查詢、更正或刪除您的個人資料。如需協助，請聯繫我們的客服團隊。
                </p>
              </li>
            </ol>
