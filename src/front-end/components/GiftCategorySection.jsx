          ...
          <a href="#" className="product-card">
            <div className="card border-0 position-relative">
              ...
              <div className="position-relative z-3">
                <div className="hot-sale position-absolute top-0 start-0 translate-middle z-4">
                  <img
                ...
                <button
                  type="button"
                  className="position-absolute btn btn-favorite p-2 z-4"
                >
              ...
              <div className="card-body z-3  p-0">
                ...
                <p className="card-title fw-semibold fs-6 mb-3">客製化鋼筆</p>
                <p className=" fs-7 text-primary-dark">
                  NT$<span className="fs-6 fw-semibold me-4">2,200</span>
