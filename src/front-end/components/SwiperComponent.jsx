...
function SwiperComponent(){
  ...
  const [carouselData] = useState([
    ...
    },
    {
      ...
      "content": {
        ...
        "notes": "1.香水為揮發型產品，建議使在手腕、耳後等脈搏部位不建議直接噴在衣物上使用，避免染色\n2.香水僅供外用，避免入眼。若不慎入眼，請清水沖洗並就醫\n3.為避免兒童誤食，請置於幼兒無法取得之處",
        "origin": "法國"
      },
      "description": "自信從氣味開始，魅力由此展現\n一款專為紳士設計的香水禮盒，融合木質與柑橘的清新調性，讓每個場合都能散發出迷人的氣場。無論是日常使用，還是作為特別場合的點綴，都能為你增添個人風格與獨特風範。",
      "id": "-OHDTEHSWJ-i19XCEwNI",
      "imageUrl": "https://storage.googleapis.com/vue-course-api.appspot.com/d3sanghooli/1736190641789.jpg?GoogleAccessId=firebase-adminsdk-zzty7%40vue-course-api.iam.gserviceaccount.com&Expires=1742169600&Signature=L3egiGftDtK4uh28k87GAhpHO%2FUQ0k%2BocP1JhysUBxI13L2ZuGHgBLVaxxprjHj7cwbONFrpEjLjKziWnBRgekpTBwdNoLhme4gt%2BmbgJ7bSxemnqy31%2FptuoceyT0rovJG4eKnRy3NMH2xxGRYLPlL%2FR6oRkBfHs2LTQxUJN6EuOoqA91pqClsUlhSHsNYIo1tOYvpDma9sxEetJ20pAh%2Fpz6Ti2qLRXx3WKMn%2F171CRn4Ea%2B%2BGuWqH%2BAkZCp2KAWK%2FJHpgu2aLsb7pKNmwgd4cD7ZFJkJG5T0S8cHy85PhaYoPNK%2BcnbDHm26BXSCp6BtQ5OQaZpGAU3GDWltf9Q%3D%3D",
      "imagesUrl": [
        ""
      ],
      "is_enabled": 1,
  ...
  return (
    <>
      <div className="mx-auto position-relative" style={{maxWidth: "1500px"}}>
        <div className='d-none d-lg-flex'>
          <div className='position-absolute translate-middle-y top-50 z-2' style={{left: '2%'}}>
            <button type="button" className='btn btn-neutral80 opacity-70 rounded-circle p-2 d-flex' onClick={handlePrevSlide}>
              <span className="material-symbols-outlined">chevron_left</span>
            </button>
          </div>
          <div className='position-absolute translate-middle-y top-50 z-2' style={{right: '2%'}}>
            <button type="button" className='btn btn-neutral80 opacity-70 rounded-circle p-2 d-flex' onClick={handleNextSlide}>
          ...
          >
            {
              carouselData.map((item) => (
                <SwiperSlide key={item.id}>
                  ...
                  <p className="fs-6">{item.category}</p>
                  <h6>{item.title}</h6>
                  <div className='text-primary-dark'>
                    <span className='fs-7'>NT$</span>
                    <span className='fs-6 fw-semibold'>{item.price}</span>
                  </div>
                </SwiperSlide>
              ))
